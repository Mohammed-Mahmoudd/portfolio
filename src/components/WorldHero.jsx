...
export default function WorldHero() {
  ...
  const sphereScale = useTransform(scrollYProgress,
    [0, 0.2, 0.8, 1],
    isMobile ? [1.2, 0.4, 0.4, 0.6] : [2.5, 0.6, 0.6, 1]
  )
  ...
  const sphereX = useTransform(scrollYProgress, 
    ...
    isMobile 
      ...
      : [0, -35, 35, -35, 0, 0] // Move to sides on desktop
  )
        ...
        <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-2xl border border-white/5 bg-black/40">
          ...
          >
            <div className="text-center relative z-20 mix-blend-difference">
              <h1 className="text-[15vw] md:text-[12vw] leading-[0.8] font-black tracking-tighter text-white font-[family-name:var(--font-space-grotesk)]">
                MY WORLD
              </h1>
              <div className="mt-8 flex justify-between items-end w-full px-2">
                ...
                <p className="text-sm md:text-xl text-zinc-300 font-light tracking-[0.2em] uppercase">Beyond Code</p>
          ...
          <motion.div 
            ...
            className="absolute inset-0 flex items-center justify-center md:justify-end z-10 px-4 md:px-24 pointer-events-none"
          >
            <div className="max-w-xl pl-6 md:pl-12 border-l-2 border-white/20 text-left">
              <span className="text-6xl md:text-8xl font-black text-white/5 absolute -left-10 -top-16 md:-left-20 md:-top-20 select-none">01</span>
              <h2 className="text-4xl md:text-6xl font-bold text-white font-[family-name:var(--font-space-grotesk)] mb-4 md:mb-8 leading-[0.9]">
                ORDER<br/><span className="text-zinc-500">IN CHAOS</span>
              </h2>
              <p className="text-lg md:text-2xl text-zinc-200 leading-relaxed font-light">
          ...
          <motion.div 
            ...
            className="absolute inset-0 flex items-center justify-center md:justify-start z-10 px-4 md:px-24 pointer-events-none"
          >
            <div className="max-w-xl pr-6 md:pr-12 md:border-r-2 border-l-2 md:border-l-0 border-white/20 text-left md:text-right pl-6 md:pl-0">
              <span className="text-6xl md:text-8xl font-black text-white/5 absolute -right-10 -top-16 md:-right-20 md:-top-20 select-none hidden md:block">02</span>
              <span className="text-6xl md:text-8xl font-black text-white/5 absolute -left-10 -top-16 select-none md:hidden">02</span>
              <h2 className="text-4xl md:text-6xl font-bold text-white font-[family-name:var(--font-space-grotesk)] mb-4 md:mb-8 leading-[0.9]">
          ...
          >
            <div className="max-w-xl pl-6 md:pl-12 border-l-2 border-white/20 text-left">
              <span className="text-6xl md:text-8xl font-black text-white/5 absolute -left-10 -top-16 md:-left-20 md:-top-20 select-none">03</span>
              <h2 className="text-4xl md:text-6xl font-bold text-white font-[family-name:var(--font-space-grotesk)] mb-4 md:mb-8 leading-[0.9]">
          ...
          >
            <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 md:grid-rows-2">
              <div className="border-b md:border-r border-white/10 p-8 md:p-12 flex flex-col justify-between">
                <span className="text-xs md:text-sm font-mono text-zinc-500">01</span>
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">STRUCTURE</h3>
                  <p className="text-sm md:text-base text-zinc-400">Solid foundations require no maintenance.</p>
                </div>
              </div>
              <div className="border-b border-white/10 p-8 md:p-12 flex flex-col justify-between items-end text-right">
                <span className="text-xs md:text-sm font-mono text-zinc-500">02</span>
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">SPEED</h3>
                  <p className="text-sm md:text-base text-zinc-400">Performance is a feature, not an afterthought.</p>
                </div>
              </div>
              <div className="border-b md:border-b-0 md:border-r border-white/10 p-8 md:p-12 flex flex-col justify-between">
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">DETAIL</h3>
                  <p className="text-sm md:text-base text-zinc-400">Chess is in the details.</p>
                </div>
                <span className="text-xs md:text-sm font-mono text-zinc-500">03</span>
              </div>
              <div className="p-8 md:p-12 flex flex-col justify-between items-end text-right">
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">SCALE</h3>
                  <p className="text-sm md:text-base text-zinc-400">Built for tomorrow, today.</p>
                </div>
